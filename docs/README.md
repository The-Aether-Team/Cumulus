...
### Release builds
Cumulus has stable builds available.
...
[![Code license (LGPL v3.0)](https://img.shields.io/badge/code%20license-LGPL%20v3.0-green.svg?style=flat-square)](https://github.com/The-Aether-Team/Cumulus/blob/1.19.4-develop/LICENSE.txt)
...
If you are thinking about using Cumulus' code or assets, please note our licensing. **All assets of Cumulus are unlicensed and all rights are reserved to them by The Aether Team and their respective authors.** The source code of Cumulus is under the LGPL v3.0 license.
